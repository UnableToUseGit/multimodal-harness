...
- Set API config through environment variables: `VIDEO_ATLAS_API_BASE`, `VIDEO_ATLAS_API_KEY`, `VIDEO_ATLAS_MODEL`.
...
- affected paths, such as `src/video_atlas/agents/video_atlas_agent.py`
