...
class LocalWorkspace(BaseWorkspace):
    ...
    def setup_workspace(self, name: str, description: str):
        ...
        # Write workspace meta data file
        meta_file = self.root_path / ".video_atlas_meta.json"
        meta_data = {
            "version": "1.0",
    ...
    def copy_from_workspace(self, workspace_path: Union[str, Path], local_path: Union[str, Path]):
        ...
        try:
            ...
            self.logger.error(f"Error copying from workspace: {repr(e)}")
            raise

    def close(self):
        """Cleanup resources."""
        self.logger.info("LocalWorkspace closed")
