...
7. Inspect generated `README.md`, `segments/`, and `.agentignore/PROBE_RESULT.json`.
8. Confirm the output directory now acts as a structured context surface for downstream LLM workflows.
